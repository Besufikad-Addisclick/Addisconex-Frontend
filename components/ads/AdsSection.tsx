...
// For ads without time_out, display singly with a simple card (no carousel)
...
export default function AdsSection({
  ...
  // Group ads into sets of three (for carousel)
    ...
    <div className={`${className} ${isFixed ? "sticky top-24 self-start" : ""}`}>
      <div className="bg-white rounded-lg shadow-sm border p-4">
        ...
        {loading ? (
          ...
          <>
            {/* Ads without time_out shown individually in vertical list, non-scrollable */}
        ...
        <div className="mt-4 pt-3 border-t border-gray-100">
          <p className="text-xs text-gray-400 text-center">
            Sponsored content • <a href="#" className="underline">Ad preferences</a>
          </p>
        </div>
