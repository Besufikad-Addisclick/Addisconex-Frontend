  ...
  const handleRatingSubmit = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Refresh consultant data to get updated rating
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <Textarea
                  id="rating-comment"
                  placeholder="Share your detailed experience with this consultant..."
                  value={ratingComment}
        ...
        <CardContent>
          {rates.length > 0 ? (
            ...
            <div className="text-center py-8">
              ...
              <p className="text-gray-500">No ratings and reviews yet. Be the first to rate and review this consultant!</p>
            </div>
          )}
        </CardContent>
      </Card>
