...
export default function OtherContractorDetail() {
      ...
      <div className="fixed inset-0 flex items-center justify-center bg-gray-100 bg-opacity-75 z-50">
        ...
        >
          ...
          <p className="text-lg font-medium text-gray-700">
            Loading other contractor details...
          </p>
        </motion.div>
      </div>
    );
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <Textarea
                  id="rating-comment"
                  placeholder="Share your detailed experience with this contractor..."
                  value={ratingComment}
        ...
        <CardContent>
          {rates.length > 0 ? (
            ...
            <div className="text-center py-8">
              ...
              <p className="text-gray-500">No ratings and reviews yet. Be the first to rate and review this contractor!</p>
            </div>
          )}
        </CardContent>
      </Card>
