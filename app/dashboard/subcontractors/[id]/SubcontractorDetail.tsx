  ...
  const handleRatingSubmit = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Refresh subcontractor data to get updated rating
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                ...
                Rate & Review This Subcontractor
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <div>
              ...
              <div>
                ...
                <Textarea
                  id="rating-comment"
                  placeholder="Share your detailed experience with this subcontractor..."
                  value={ratingComment}
        ...
        <CardContent>
          {rates.length > 0 ? (
            ...
            <div className="text-center py-8">
              ...
              <p className="text-gray-500">No ratings and reviews yet. Be the first to rate and review this subcontractor!</p>
            </div>
          )}
        </CardContent>
      </Card>
